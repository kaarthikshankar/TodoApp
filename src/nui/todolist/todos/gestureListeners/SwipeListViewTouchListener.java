...
package nui.todolist.todos.gestureListeners;
...
public class SwipeListViewTouchListener implements View.OnTouchListener
{
	...
	private boolean dismissLeft = false;
	...
	// Animation response refinement properties
	private final int SLOP_REFINMENT = 2;
	private final int MIN_FLING_REFINMENT = 8;
	...
	public SwipeListViewTouchListener(ListView listView, OnSwipeCallback callback) 
	{
		...
		mSlop = vc.getScaledTouchSlop() * SLOP_REFINMENT;
		mMinFlingVelocity = vc.getScaledMinimumFlingVelocity() * MIN_FLING_REFINMENT;
	...
	public boolean onTouch(View view, MotionEvent motionEvent)
	{
		...
		case MotionEvent.ACTION_UP:
		{
			...
			float velocityX = Math.abs(mVelocityTracker.getXVelocity()) / 2;
