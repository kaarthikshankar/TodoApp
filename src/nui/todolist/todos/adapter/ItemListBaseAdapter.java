...
package nui.todolist.todos.adapter;
...
{	
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
	{
        ...
        if (convertView == null) 
        {
            ...
            holder.locationText = (TextView) convertView.findViewById(R.id.taskLocation);
        ...
        holder.locationText.setTag(childPosition);
    	...
    	holder.locationText.setText(taskListModel.getTaskAt(groupPosition).getLocation());
        ...
        if (Utils.ENGLISH_LANGUAGE == false)
        {
        	...
        	if (taskListModel.getTaskAt(groupPosition).getLocation().equals(Utils.DEFUALT_LOCATION))
        	{
        		holder.locationText.setText("ללא התראת מיקום");
        	}
        }
        return convertView;
    }
