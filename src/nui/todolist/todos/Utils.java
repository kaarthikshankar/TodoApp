...
import nui.todolist.todos.view.MainActivity;
...
public class Utils
{
	...
	public static final String EXAMPLE_ALERT = "Hello there ?";
    ...
    public static void makeHebrewContextMenu(ContextMenu menu)
    {
    	...
    	item = menu.findItem(R.id.setLocation);
    	item.setTitle("הוסף מיקום");
    ...
    public static void makeHebrewOptionsMenu(Menu menu)
    {
    	...
    	item = menu.findItem(R.id.change_language);
    	item.setTitle("שנה שפה לאנגלית");
    	item = menu.findItem(R.id.change_notification_sound);
    ...
    public static void makeEnglishOptionsMenu(Menu menu)
    {
    	...
    	item = menu.findItem(R.id.change_language);
    	item.setTitle("Change Language (Hebrew)");
    	item = menu.findItem(R.id.change_notification_sound);
    	
    	if (Utils.IS_DEFAULT_SOUND)
    	{
    		item.setTitle("Change Alert Sound (LOUD)");
    	}
    	else 
    	{
    		item.setTitle("Change Alert Sound (DEFAULT)");
    	}
