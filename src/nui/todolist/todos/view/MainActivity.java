...
import nui.todolist.todos.MediaPlayerHandler;
import nui.todolist.todos.R;
import nui.todolist.todos.Utils;
import nui.todolist.todos.adapter.ItemListBaseAdapter;
import nui.todolist.todos.data.Task;
import nui.todolist.todos.data.TaskList;
import nui.todolist.todos.gestureListeners.ShakeEventListener;
import nui.todolist.todos.gestureListeners.SwipeListViewTouchListener;
import nui.todolist.todos.notifications.TaskAlarms;
	...
	ItemListBaseAdapter.NoticeAlarmListener, AlarmAlertDialog.SetAlarmListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		SwipeListViewTouchListener touchListener = 
				new SwipeListViewTouchListener(expandableListView, new SwipeListViewTouchListener.OnSwipeCallback()
				{
					...
					{
						alertDialog = new AlertDialogs();
						alertDialog.setArguments(getArguments(Utils.DIALOG_YES_NO_MESSAGE,currentPosition,Utils.EXAMPLE_ALERT));
						alertDialog.show(getFragmentManager(),"ShowAlertDialog");
					}
					@Override
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.change_language:
			...
			{
				Utils.ENGLISH_LANGUAGE = false;
				savePreferences(Utils.LANGUAGE, false);
				titleTextField.setHint(Utils.HEBREW_TITLE_ENTER);
			}
			else 
			{
				Utils.ENGLISH_LANGUAGE = true;
				savePreferences(Utils.LANGUAGE, true);
				titleTextField.setHint(Utils.ENGLISH_TITLE_ENTER);
			}
			adapter.notifyDataSetChanged();
			return true;
